...
<body>
    <p><br/></p>
    <div class="container">
    	<h2>이곳은 test06.jsp입니다.</h2>
		<hr>
		<div>
			<form method="post">
				<div>성명 : <input type="text" name="name" value="홍길동" class="form-control mb-2" placeholder="성명을 입력하세요." autofocus required></div>
				<div>나이 : <input type="number" name="age" value="20" class="form-control mb-2" placeholder="나이를 입력하세요." required></div>
				<div class="mb-2">성별 : 
